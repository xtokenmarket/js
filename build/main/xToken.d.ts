...
import { AAVE_X_AAVE_A_CLR, BNT_X_BNT_A_CLR, INCH_X_INCH_A_CLR, INCH_X_INCH_B_CLR, LENDING_LPT, X_AAVE_A, X_AAVE_B, X_AAVE_B_AAVE_CLR, X_ALPHA_A, X_ALPHA_A_ALPHA_CLR, X_BNT_A, X_BTC_3X, X_ETH_3X, X_INCH_A, X_INCH_B, X_KNC_A_KNC_CLR, X_KNC_B_KNC_CLR, X_SNX_A, X_SNX_A_SNX_CLR, X_U3LP_A, X_U3LP_B, X_U3LP_C, X_U3LP_D, X_U3LP_E, X_U3LP_F, X_U3LP_G, X_U3LP_H, XTK_ETH_CLR } from '@xtoken/abis';
import { IAsset, IAssetId, ICLRBurnQty, ICLRMintQty, ICollateralType, IHistoryType, ILendingMarket, ILendingMarketInfo, ILendingPricing, ILendingType, ILevAsset, ILiquidityPoolItem, ILPAsset, ILPTokenSymbols, INativeAssets, IPortfolioItem, IReturns, IStableAssets, ITokenPrices, ITokenSymbols, ITradeType, IXAssetCLR, IXAssetLev } from './types/xToken';
/**
...
export declare class XToken {
     ...
     */
    approve(symbol: ITokenSymbols | ILPTokenSymbols | IStableAssets | IXAssetCLR | IXAssetLev, amount?: string, inputAsset?: IAssetId, spenderAddress?: string): Promise<ContractTransaction>;
    /**
     ...
     * @returns A promise of the transaction response
     */
    burn(symbol: ITokenSymbols | ILPTokenSymbols | IXAssetLev, sellForEth: boolean, amount: string): Promise<ContractTransaction>;
    /**
     ...
     * @returns A promise of the transaction response
     */
    collateral(marketName: ILendingMarket, amount: string, type: ICollateralType): Promise<ContractTransaction>;
    /**
     * @example
     * ```typescript
     ...
     */
    getBestReturn(symbol: ITokenSymbols | ILPTokenSymbols | IXAssetLev, tradeWithEth: boolean, amount: string, tradeType: ITradeType): Promise<IReturns>;
    /**
     ...
     */
    getExpectedQuantityOnBurn(symbol: ITokenSymbols | ILPTokenSymbols | IXAssetLev, sellForEth: boolean, amount: string): Promise<string>;
    /**
     * @example
     * ```typescript
     ...
     */
    getExpectedQuantityOnMint(symbol: ITokenSymbols | ILPTokenSymbols | IXAssetLev, tradeWithEth: boolean, amount: string): Promise<string>;
    /**
     ...
     */
    getMaxRedeemable(symbol: typeof X_AAVE_A | typeof X_AAVE_B | typeof X_ALPHA_A | typeof X_BNT_A | typeof X_INCH_A | typeof X_INCH_B | typeof X_SNX_A | typeof X_U3LP_A | typeof X_U3LP_B | typeof X_U3LP_C | typeof X_U3LP_D | typeof X_U3LP_E | typeof X_U3LP_F | typeof X_U3LP_G | typeof X_U3LP_H | typeof AAVE_X_AAVE_A_CLR | typeof BNT_X_BNT_A_CLR | typeof INCH_X_INCH_A_CLR | typeof INCH_X_INCH_B_CLR | typeof X_AAVE_B_AAVE_CLR | typeof X_ALPHA_A_ALPHA_CLR | typeof X_KNC_A_KNC_CLR | typeof X_KNC_B_KNC_CLR | typeof X_SNX_A_SNX_CLR | typeof XTK_ETH_CLR | typeof X_BTC_3X | typeof X_ETH_3X, outputAsset?: IAssetId): Promise<string>;
    /**
     ...
     * @returns
     */
    getTokenAllowance(symbol: INativeAssets | ITokenSymbols | ILPTokenSymbols | IStableAssets | typeof LENDING_LPT, spenderAddress: string): Promise<string>;
    /**
     * Get token balance for an address of ERC20 token or xAssets
     * @returns
     */
    getTokenBalance(symbol: INativeAssets | ITokenSymbols | IStableAssets | typeof LENDING_LPT): Promise<string>;
    /**
     * Get token supply of ERC20 token or xAssets
     * @returns
     */
    getTokenSupply(symbol: INativeAssets | ITokenSymbols | IStableAssets | typeof LENDING_LPT): Promise<string>;
    /**
     ...
     */
    getTradeEstimateXAssetCLR(symbol: IXAssetCLR, tradeAsset: IAssetId, amount: string, tradeType: ITradeType): Promise<ICLRBurnQty | ICLRMintQty>;
    /**
     * @example
     * ```typescript
     ...
     * @returns A promise of the transaction response
     */
    mint(symbol: ITokenSymbols | ILPTokenSymbols | IXAssetLev, tradeWithEth: boolean, amount: string, affiliate?: string): Promise<ContractTransaction>;
    /**
     ...
     */
    getXtkHistory(type: IHistoryType): Promise<readonly import("./types/xToken").IStakeHistory[]>;
    /**
