...
ava_1.default('Get Uniswap Portfolio of xKNCa', async (t) => {
    const portfolio = await uniswap_1.getUniswapPortfolioItem(abis_1.X_KNC_A, constants_spec_1.testAddress, constants_spec_1.provider);
    console.log('[Uniswap] Portfolio value of xKNCa:', portfolio === null || portfolio === void 0 ? void 0 : portfolio.value);
...
ava_1.default('Get Uniswap Portfolio of xKNCb', async (t) => {
    const portfolio = await uniswap_1.getUniswapPortfolioItem(abis_1.X_KNC_B, constants_spec_1.testAddress, constants_spec_1.provider);
    console.log('[Uniswap] Portfolio value of xKNCb:', portfolio === null || portfolio === void 0 ? void 0 : portfolio.value);
    t.true(Number(portfolio === null || portfolio === void 0 ? void 0 : portfolio.value) > 0);
});
