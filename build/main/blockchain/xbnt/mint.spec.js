...
ava_1.default(
  'Calculate xBNTa expected quantity on mint with ETH',
  async (t) => {
    const expectedQty = await mint_1.getExpectedQuantityOnMintXBnt(
      abis_1.X_BNT_A,
      true,
      '1',
...
ava_1.default(
  'Calculate xBNTa expected quantity on mint with BNT',
  async (t) => {
    const expectedQty = await mint_1.getExpectedQuantityOnMintXBnt(
      abis_1.X_BNT_A,
      false,
