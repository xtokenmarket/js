...
ava_1.default('Get xKNCa portfolio balance', async (t) => {
    const portfolioItem = await portfolio_1.getPortfolioItemXKnc(abis_1.X_KNC_A, constants_spec_1.testAddress, constants_spec_1.provider);
...
ava_1.default('Get xKNCb portfolio balance', async (t) => {
    const portfolioItem = await portfolio_1.getPortfolioItemXKnc(abis_1.X_KNC_B, constants_spec_1.testAddress, constants_spec_1.provider);
