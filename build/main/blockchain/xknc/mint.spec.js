...
ava_1.default('Calculate xKNCa expected quantity on mint with KNC', async (t) => {
    const expectedQty = await mint_1.getExpectedQuantityOnMintXKnc(abis_1.X_KNC_A, false, '1', constants_spec_1.provider);
...
ava_1.default('Calculate xKNCb expected quantity on mint with KNC', async (t) => {
    const expectedQty = await mint_1.getExpectedQuantityOnMintXKnc(abis_1.X_KNC_B, false, '1', constants_spec_1.provider);
