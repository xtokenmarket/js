...
ava_1.default('Get xAAVEa portfolio balance', async (t) => {
    const portfolioItem = await portfolio_1.getPortfolioItemXAave(abis_1.X_AAVE_A, constants_spec_1.testAddress, constants_spec_1.provider);
...
ava_1.default('Get xAAVEb portfolio balance', async (t) => {
    const portfolioItem = await portfolio_1.getPortfolioItemXAave(abis_1.X_AAVE_B, constants_spec_1.testAddress, constants_spec_1.provider);
