...
ava_1.default('Get maximum redeemable xAAVEa', async (t) => {
    const maxRedeemable = await redeem_1.getMaximumRedeemableXAave(abis_1.X_AAVE_A, constants_spec_1.provider);
...
ava_1.default('Get maximum redeemable xAAVEb', async (t) => {
    const maxRedeemable = await redeem_1.getMaximumRedeemableXAave(abis_1.X_AAVE_B, constants_spec_1.provider);
