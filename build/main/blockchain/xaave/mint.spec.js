...
ava_1.default(
  'Calculate xAAVEa expected quantity on mint with ETH',
  async (t) => {
    const expectedQty = await mint_1.getExpectedQuantityOnMintXAave(
      abis_1.X_AAVE_A,
      true,
      '1',
...
ava_1.default(
  'Calculate xAAVEa expected quantity on mint with AAVE',
  async (t) => {
    const expectedQty = await mint_1.getExpectedQuantityOnMintXAave(
      abis_1.X_AAVE_A,
      false,
...
ava_1.default(
  'Calculate xAAVEb expected quantity on mint with ETH',
  async (t) => {
    const expectedQty = await mint_1.getExpectedQuantityOnMintXAave(
      abis_1.X_AAVE_B,
      true,
...
ava_1.default(
  'Calculate xAAVEb expected quantity on mint with AAVE',
  async (t) => {
    const expectedQty = await mint_1.getExpectedQuantityOnMintXAave(
      abis_1.X_AAVE_B,
      false,
