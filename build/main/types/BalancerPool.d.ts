...
interface BalancerPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class BalancerPool extends Contract {
  ...
  estimateGas: {
    ...
    'isBound(address)'(t: string, overrides?: CallOverrides): Promise<BigNumber>
    ...
    setSwapFee(swapFee: BigNumberish, overrides?: Overrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    isBound(t: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
