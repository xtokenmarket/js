...
export declare const infuraApiKey: string
export declare const testAddress: string
export declare const oneAddress = '0x0000000000000000000000000000000000000001'
export declare const arbitrumRinkebyProvider: ethers.providers.JsonRpcProvider
