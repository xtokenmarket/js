...
test('Calculate expected quantity on burn of xINCHa for ETH on 1Inch', async (t) => {
    const expectedQty = await getInchEstimatedQuantity(ETH, X_INCH_A, '1000', SELL, provider);
...
test('Calculate expected quantity on burn of xINCHa for INCH on 1Inch', async (t) => {
    const expectedQty = await getInchEstimatedQuantity(X_INCH_A, X_INCH_A, '1000', SELL, provider);
...
test('Calculate expected quantity on mint of xINCHa from ETH on 1Inch', async (t) => {
    const expectedQty = await getInchEstimatedQuantity(ETH, X_INCH_A, '1', BUY, provider);
...
test('Calculate expected quantity on mint of xINCHa from INCH on 1Inch', async (t) => {
    const expectedQty = await getInchEstimatedQuantity(X_INCH_A, X_INCH_A, '100', BUY, provider);
