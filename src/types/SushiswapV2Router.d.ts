...
interface SushiswapV2RouterInterface extends ethers.utils.Interface {
  functions: {
...
export class SushiswapV2Router extends Contract {
  ...
  interface: SushiswapV2RouterInterface
